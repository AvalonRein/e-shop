...
export default function Login() {
    ...
    const handleLogin =(e)=>{
        ...
        instance.post('/api/auth/login',formData).then(x=>{
            ...
            <div className='w-full h-[100vh] flex items-center justify-center'>
                <div className='w-[600px] flex justify-center bg-white z-[1] rounded-md px-6 py-10'>
                    <div className='w-full px-20'>
                        ...
                        <Link href={'http://localhost:3333/api/auth/google/redirect'} type="button" class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2 w-full justify-center">
