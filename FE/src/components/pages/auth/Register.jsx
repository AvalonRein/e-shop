            ...
            <div className='w-full h-[100vh] flex items-center justify-center'>
                <div className='w-[600px] flex justify-center bg-white z-[1] rounded-md px-6 py-10'>
                    <div className='w-full px-20'>
                        <h1 className='text-4xl font-semibold text-center '>Register Form</h1>
                        <form onSubmit={handleLogin} className='my-5 flex flex-col gap-4'>
                            <TextField id="fullname" label="Full Name" variant="outlined" name='fullname' type='text' />
                            ...
                            <TextField id="repassword" label="Confirm Password" variant="outlined" name='repassword' type='password' className='w-full' />
                            <div className='w-full flex justify-end'>
                                <Link href="/login" className='text-sm text-blue-500 border-b-2  hover:border-blue-300 border-white  w-fit'><h1 className='pb-1'>You have an account? Login</h1></Link>
                            </div>
